...
max(rowSums(no_match_count_table))
...
metaphlan_tree_names$microbe_names[grepl("vulgatus", metaphlan_tree_names$microbe_names, ignore.case=TRUE)]

count_tab_names$microbe_names[(grepl("vulgatus", count_tab_names$microbe_names))]
