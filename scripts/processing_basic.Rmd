...
# need to change the name for a couple of bugs in the metaphlan tree because the name doesn't match up to the count table
metaphlan_tree_names$species[metaphlan_tree_names$species=="Bacteroides_vulgatus"] <- "Phocaeicola_vulgatus"
metaphlan_tree_names$species[metaphlan_tree_names$species=="Bacteroides_dorei"] <- "Phocaeicola_dorei"
metaphlan_tree_names$species[metaphlan_tree_names$species=="Bacteroides_plebeius"] <- "Phocaeicola_plebeius"
metaphlan_tree_names$species[metaphlan_tree_names$species=="Eubacterium_eligens"] <- "Lachnospira_eligens"
metaphlan_tree_names$species[metaphlan_tree_names$species=="Eubacterium_hallii"] <- "Anaerobutyricum_hallii"

# rename the tree labels so that they match those that are in the count table
# make a tree that has the names of the bugs that are in the count table as well
